function webSocketSession(){
	...
	websocket = new WebSocket("ws://127.0.0.1:8080/ssm/echo");
	...
	websocket.onmessage = function (evnt) {
		...
		var message="<li class='meida alert "+style+" ' role='alert'><div class='media-left'><img src='./../images/"+image+".png' width='30px'"+
